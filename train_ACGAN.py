...
from utils import weights_init, compute_acc, ImageFolder
from ACGAN_net import _netG, _netD, _netD_CIFAR10, _netG_CIFAR10
...
parser.add_argument('--outf', default='./train/ACGAN', help='folder to output images and model checkpoints')
